<template>
  <div class="container welcome">
    ...
    <div v-if="shouldShowLoginForm">
      <LoginForm @redirectToLiveChatroom="redirectToLiveChatroom" />
      <p class="change-form">初めての方は<span @click="shouldShowLoginForm = false">こちら</span>をクリック</p>
    </div>
    <div v-if="!shouldShowLoginForm">
       <SignupForm @redirectToLiveChatroom="redirectToLiveChatroom" />
...
export default {
  ...
  methods: {
    redirectToLiveChatroom () {
      this.$router.push({ name: 'LiveChatroom' })
    }
  }
}
</script>
